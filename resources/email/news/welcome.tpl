...
<html lang="en">
	...
	<body id="kt_body" class="app-blank app-blank">
					...
					<div id="#kt_app_body_content" style="background-color:#D5D9E2; font-family:Arial,Helvetica,sans-serif; line-height: 1.5; min-height: 100%; font-weight: normal; font-size: 15px; color: #2F3044; margin:40px; padding:40px; width:100%;">
										...
										<td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
											...
											<div style="text-align:center; margin:0 15px 34px 15px">
												...
												<div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
													<p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">Hey Marcus, 感谢您的注册</p>
