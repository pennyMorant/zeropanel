                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="留空为不限制" id="stock" name="name" type="number" placeholder="产品库存" value="">
                                                    ...
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="留空为不限制" id="speed_limit" name="speed_limit" type="number" placeholder="产品速度" value="">
                                                    <label class="form-label">产品IP</label>
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="留空为不限制" id="ip_limit" name="ip_limit" type="number" placeholder="产品IP" value="">
