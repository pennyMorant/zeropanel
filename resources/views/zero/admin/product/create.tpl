                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" data-bs-toggle="tooltip" title="0为不限制" id="speed_limit" name="speed_limit" type="number" placeholder="产品速度" value="0">
                                                        <span class="input-group-text">Mbps</span>
                                                    </div>
                                                    <label class="form-label">产品IP</label>
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" data-bs-toggle="tooltip" title="0为不限制" id="ip_limit" name="ip_limit" type="number" placeholder="产品IP" value="0">
