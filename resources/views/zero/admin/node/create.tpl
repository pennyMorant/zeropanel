                                        ...
                                        <div class="col-xxl-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="0为不限制" id="node_traffic" name="node_traffic" type="text" value="0" placeholder="流量上限">
                                                    <label class="form-label">流量上限清空日</label>
                                                    <input class="form-control mb-5" id="node_traffic_reset_date" name="node_traffic_reset_date" type="text" value="1" placeholder="流量上限清空日">
