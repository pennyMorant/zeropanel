                ...
                <div class="card-main">
                    <div class="card-inner">
                        ...
                        <div class="form-group form-group-label">
                            ...
                            <input class="form-control maxwidth-edit" id="discount" type="text">
                        ...
                        <div class="form-group form-group-label">
                            ...
                            <input class="form-control maxwidth-edit" id="limited_product" type="text">
                        ...
                        <div class="form-group form-group-label">
                            ...
                            <input class="form-control maxwidth-edit" id="per_use_count" type="number" value="1">
                        </div>

                        <div class="form-group form-group-label">
                            <label class="floating-label" for="shop">优惠码可用次数，-1为无限次</label>
                            <input class="form-control maxwidth-edit" id="total_use_count" type="number" value="-1">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10 col-md-push-1">
                                    <button id="create_coupon" type="submit"
...
<script>
    ...
    window.addEventListener('load', () => {
        ...
        $$.getElementById('create_coupon').addEventListener('click', () => {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    limited_product: $$getValue('limited_product'),
                    per_use_count: $$getValue('per_use_count'),
                    total_use_count: $$getValue('total_use_count'),
