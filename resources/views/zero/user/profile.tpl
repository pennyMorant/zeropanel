                                                            ...
                                                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                                                <tbody class="fs-6 fw-semibold text-gray-600">
                                                                    <tr>
                                                                        ...
                                                                        <td>{$user->name}</td>
                                                                        <td class="text-end">
                                                                            <button type="button" class="btn btn-icon btn-active-light-primary w-30px h-30px ms-auto" data-bs-toggle="modal" data-bs-target="#zero_modal_user_update_name">
...
<div class="modal fade" id="zero_modal_user_update_name" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<div class="modal-content">
			<div class="modal-header">
				<h2 class="fw-bold">更改用户名称</h2>
			</div>
			<div class="modal-body scrolly-y mx-5 mx-xl-15 my-7">
				<form class="form" action="#" id="zero_modal_user_update_name_form">
				    <div class="fv-row mb-7">
					    <label class="fs-6 fw-semibold form-label mb-2">
							<span class="required">User name</span>
						</label>
						<input class="form-control form-control-solid" placeholder="" name="profile_name" value="" type="text" id="profile_name" />
					</div>
				    <div class="text-center pt-15">
						<button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal">{$trans->t('general.cancel')}</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateWithdrawAccount()">{$trans->t('general.confirm')}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="zero_user_withdraw_modal" tabindex="-1" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
				<button type="button" class="btn btn-light" data-bs-dismiss="modal">{$trans->t('general.cancel')}</button>
                <button type="button" class="btn btn-primary" type="button" onclick="withdrawCommission()">{$trans->t('general.confirm')}</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" data-kt-users-action="submit" onclick="KTUsersCreateOrder('add_credit_order')">
					<span class="indicator-label">{$trans->t('general.confirm')}</span>			
					<span class="indicator-progress">Please wait...
					<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
				</button>
            </div>
