                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header border-bottom">
                                                    ...
                                                    {$trans->t('tutorial.android.surfboard.text_0')}
                                                    </div>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row p-5">
                                                        <div class="col-sm-12 col-md-12 pb-5 text-center fs-4">
                                                            <p class="fs-1 pb-5"><strong>{$trans->t('tutorial.android.surfboard.text_1')}</strong></p>
                                                            <div class="text-center">
                                                                <p><code>surfboard</code>{$trans->t('tutorial.android.surfboard.text_2')}{$trans->t('tutorial.android.surfboard.text_3')}</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row p-5">
                                                        <div class="col-sm-12 col-md-12 pb-5 text-center fs-4">
                                                            <p class="fs-1 pb-5"><strong>{$trans->t('tutorial.android.surfboard.text_4')}</strong></p>
                                                            <a href="{$zeroconfig['client_android']['surfboard']['down']}" class="btn btn-pill btn-surfboard mb-4">&nbsp;&nbsp;<i class="zero-surfboard text-white"></i>{$trans->t('tutorial.android.surfboard.text_5')}</a>&nbsp;&nbsp;&nbsp;
                                                            <p class="mb-2">{$trans->t('tutorial.android.surfboard.text_6')}</p>
                                                        </div>
                                                    ...
                                                    <div class="row p-5">
                                                        <div class="col-sm-12 col-md-12 pb-5 text-center fs-4">
                                                            <p class="fs-1 pb-5"><strong>{$trans->t('tutorial.android.surfboard.text_7')}</strong></p>
                                                            {if in_array('surfboard',$zeroconfig['index_sub'])}
                                                            <div class="drowdown mb-5 mr-3">
                                                                <button type="button" class="btn btn-surfboard dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">&nbsp;&nbsp;<i class="zero-surfboard text-white"></i>{$trans->t('tutorial.android.surfboard.text_8')}&nbsp;&nbsp;</button>
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item copy-text" href="javasript:;" data-clipboard-text="{$subInfo["surfboard"]}">{$trans->t('tutorial.android.surfboard.text_9')}</a></li>
            
                                                                    <li><a class="dropdown-item" href="javasript:;" onclick="oneclickImport('surfboard', '{$subInfo["surfboard"]}')">{$trans->t('tutorial.android.surfboard.text_10')}</a></li>
                                                                </ul>
                                                            </div>
                                                            {/if}
                                                        
                                                            <p class="mb-2">{$trans->t('tutorial.android.surfboard.text_11')}</p>
