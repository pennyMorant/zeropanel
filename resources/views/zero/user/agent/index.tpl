                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
										...
										<div class="col-xl-4 mb-xl-10">
											...
											<div class="card h-md-100">
												...
												<div class="card-body d-flex flex-column flex-center">
													...
													<div class="mb-2">
														<!--begin::Title-->
														<h1 class="fw-semibold text-gray-800 text-center lh-lg">设置好账户
														<br />
														<span class="fw-bolder">开始赚钱吧！</span></h1>
														<!--end::Title-->
														<!--begin::Illustration-->
														<div class="py-10 text-center">
															<img src="/theme/zero/assets/media/svg/illustrations/easy/4.svg" class="w-200px" alt="" />
														</div>
														<!--end::Illustration-->
													</div>
													<!--end::Heading-->
													...
													<div class="text-center mb-1">
														<!--begin::Link-->
														<a class="btn btn-sm btn-primary me-2" data-bs-target="#zero_agent_withdraw_method_modal" data-bs-toggle="modal">账户设置</a>
														<!--end::Link-->
														...
														<div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
															<div class="mb-4 px-9">
																<div class="d-flex align-items-center mb-2">
																	<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{$back_sum}</span>
																	<span class="d-flex align-items-end text-gray-400 fs-6 fw-smibold">$</span>
																</div>
																<span class="fs-6 fw-semibold text-gray-400">累计佣金</span>
															</div>
															<div id="zero_referral_total_commission_chart" class="min-h-auto" style="height: 125px;"></div>
														</div>
													</div>
													<div class="card card-flush h-md-50 mb-lg-10">
														<div class="card-header pt-5">
															<div class="card-title d-flex flex-column">
																<span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{$user->commission + $user->money}</span>
																<span class="text-gray-400 pt-1 fw-semibold fs-6">钱包金额</span>
															</div>
															<div class="card-toolbar">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
																	...
																	<div class="menu-item px-3">
																		<a data-bs-toggle="modal" type="button" data-bs-target="#zero_agent_add_credit_modal" class="menu-link px-3">账户充值</a>
																	</div>
																	<div class="menu-item px-3 mb-3">
																		<a data-bs-toggle="modal" type="button" data-bs-target="#zero_agent_withdraw_modal" class="menu-link px-3">佣金提现</a>
																	</div>
																</div>
															</div>
														</div>
														<div class="card-body d-flex align-items-end pt-0">
															<div class="d-flex align-items-center flex-wrap">
																<div class="d-flex me-7 me-xxl-10">
																	<div id="zero_referral_commission_used_chart" class="min-h-auto" style="height: 78px; width: 78px" data-kt-size="78" data-kt-line="11"></div>
																</div>
																<!--end::Chart-->
																<!--begin::Labels-->
																<div class="d-flex flex-column content-justify-center flex-grow-1">
																	...
																	<div class="d-flex fs-6 fw-semibold align-items-center">
																		...
																		<!--end::Bullet-->
																		<!--begin::Label-->
																		<div class="fs-6 fw-semibold text-gray-400 flex-shrink-0">可使用金额</div>
																		<!--end::Label-->
																		<!--begin::Separator-->
																		<div class="separator separator-dashed min-w-10px flex-grow-1 mx-2"></div>
																		<!--end::Separator-->
																		<!--begin::Stats-->
																		<div class="ms-auto fw-bolder text-gray-700 text-end" id="agent_balance">{$user->money}</div>
																		<!--end::Stats-->
																	</div>
																	<!--end::Label-->
																	<!--begin::Label-->
																	<div class="d-flex fs-6 fw-semibold align-items-center my-1">
																		...
																		<!--end::Bullet-->
																		<!--begin::Label-->
																		<div class="fs-6 fw-semibold text-gray-400 flex-shrink-0">可提现佣金</div>
																		<!--end::Label-->
																		<!--begin::Separator-->
																		<div class="separator separator-dashed min-w-10px flex-grow-1 mx-2"></div>
																		<!--end::Separator-->
																		<!--begin::Stats-->
																		<div class="ms-auto fw-bolder text-gray-700 text-end" id="agent_commission">{$user->commission}</div>
																		<!--end::Stats-->
																	</div>
																	<!--end::Label-->
												...
												<div class="col-md-6 col-xl-6 mb-md-5 mb-xl-10">
													<div class="card overflow-hidden h-md-50 mb-5 mb-xl-10">
														<div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
															<div class="mb-4 px-9">
																<div class="d-flex align-items-center mb-2">
																	<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{$user_num}</span>
																</div>
																<span class="fs-6 fw-semibold text-gray-400">用户数</span>
															</div>
															<div class="min-h-auto" style="height: 125px" id="zero_referral_total_users_chart"></div>
														</div>
													</div>
													<div class="card card-flush h-md-50 mb-lg-10">
														<div class="card-header pt-5">
															<div class="card-titl d-flex flex-column">
																<span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">30%</span>
																<span class="text-gray-400 pt-1 fw-semibold fs-6">佣金比例</span>
															</div>
														</div>
														<div class="card-body d-flex flex-column justify-content-end pe-0">
															<!--begin::Title-->
															<span class="fs-6 fw-bolder text-gray-800 d-block mb-2">活跃用户</span>
															<!--end::Title-->
															<!--begin::Users group-->
															<div class="symbol-group symbol-hover flex-nowrap">
																
																{foreach $all_active_users as $active_user}
																	{if $active_user@iteration <= 6}
																		<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="{$active_user->name}">
																			<img alt="Pic" src="{$active_user->gravatar}" />
																		</div>																
																	{/if}
																{/foreach}
																<a class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="活跃用户总数">
																	<span class="symbol-label bg-light text-gray-400 fs-8 fw-bold">+{count($all_active_users)}</span>
																</a>
															</div>
															<!--end::Users group-->
														</div>
                                        ...
                                        <div class="mb-5">
                                            <div class="card">
                                                ...
                                                <div class="card-body pt-0">
                                                    <!-- begin datatable -->
                                                    <table class="table align-middle table-striped table-row-bordered gy-5 gs-7" id="zero_agent_withdraw_commission_log_table">
                                                        <thead>
                                            ...
                                            <div class="card card-flush">
                                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                                    ...
                                                    <div class="card-toolbar">
                                                        ...
                                                        <button class="btn btn-primary ms-3" data-bs-toggle="modal" data-bs-target="#zero_agent_add_new_user_modal">Add User</button>
								...
								{else}
									<div class="card flush">
										<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%;background-image:url('/theme/zero/assets/media/stock/900x600/42.png');">
											<div class="mb-10">
												<div class="fs-2hx fw-bold text-gray-800 text-center mb-13">
													...
													<br>
														...
														<span class="position-relative d-inline-block text-danger">
															<a class="text-danger opacity-75-hover">代理销售</a>
														</span>
													</span>
													
												</div>
												<div class="text-center">
													<a class="btn btn-sm btn-dark fw-bold">升级账户</a>
												</div>
											</div>
											<img class="mx-auto h-250px h-lg-400px theme-light-show" src="/theme/zero/assets/media/illustrations/misc/upgrade.svg" alt>
											<img class="mx-auto h-250px h-lg-400px theme-dark-show" src="/theme/zero/assets/media/illustrations/misc/upgrade-dark.svg" alt>
										</div>
									</div>
								{/if}	
                                </div>
...
<!-- 提现帐号设置 -->
<div class="modal fade" id="zero_agent_withdraw_method_modal" data-bs-backdrop="static" tabindex="-1" data-bs-keyboard="false" aria-hidden="true">
...
<!-- 提现 -->
<div class="modal fade" id="zero_agent_withdraw_modal" data-bs-backdrop="static" tabindex="-1" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- modal add balance -->
<div class="modal fade" id="zero_agent_add_credit_modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
...
<!-- add new user modal -->
<div class="modal fade" id="zero_agent_add_new_user_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">创建新客户</h5>
			</div>
			<div class="modal-body">				
				<label class="col-form-label fw-bold" for="recipient-name">邮箱:</label>
				<form class="mb-3">
					<input class="form-control" type="text" id="zero_agent_new_user_email">
				</form>
			</div>
			<div class="modal-footer">
				<button class="btn btn-primary" type="button" onclick="agent_add_user()">创建</button>
