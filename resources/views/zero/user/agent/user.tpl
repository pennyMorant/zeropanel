                                ...
                                <div id="kt_app_content_container" class="app-container container-xxl">
                                    <div class="card card-flush mb-xl-9 mb-6">
                                        <div class="card-header">
                                            ...
                                            <div class="card-toolbar">
                                                <button class="btn btn-light-primary" type="button" onclick="agent_update_user('{$agent_referral_user->id}','update_user_profile')">修改</button>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <table class="table align-middle table-row-dashed gy-5">
                                                    <tbody class="fs-6 fw-semibold text-gray-600">
                                                        ...
                                                        <tr>
                                                            <td>Email</td>
                                                            <td>
                                                                <input class="form-control" type="text" id="agent_user_email" value="{$agent_referral_user->email}">       
                                                            </td>                                                            
                                                        </tr>
                                                        <tr>
                                                            <td>password</td>
                                                            <td>
                                                                <input class="form-control" type="password" id="agent_user_passwd" placeholder="不修改请留空">       
                                                            </td>                                                           
                                                        </tr>
                                                        <tr>
                                                            <td>是否启用</td>
                                                            <td class="text-end">
                                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                                    <input class="form-check-input" type="checkbox" {if $agent_referral_user->enable === 1}checked="checked"{/if} id="agent_user_enable">
                                                                </div>
                                                            </td>                                                           
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <div class="card card-flush mb-xl-9 mb-6">
                                        <div class="card-header">
                                            ...
                                            <div class="card-toolbar">
                                                <button class="btn btn-light-primary" type="button" onclick="agent_update_user('{$agent_referral_user->id}','purchase_product')">购买</button>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table align-middle table-row-dashed gy-5">
                                                    <tbody class="fs-6 fw-semibold text-gray-600">
                                                        <tr>
                                                            <td>套餐</td>
                                                            <td>                                                               
                                                                <select class="form-select form-select-lg" id="zero_agent_purchase_product">
                                                                    <option selected>不开通套餐</option>
                                                ...
                                                <p>为用户购买指定产品需从您的账户可使用金额扣除相应的的金额, 同时获得相应比例的佣金到佣金账户, 套餐详情可至商店查看</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card card-flush mb-xl-9 mb-6">
                                        <div class="card-header">
                                            ...
                                            <div class="card-toolbar">
                                                <button class="btn btn-light-primary" type="button" onclick="agent_update_user('{$agent_referral_user->id}','reset_link')">重置订阅链接</button>
                                            </div>
                                        </div>
                                        <div class="card-body">
