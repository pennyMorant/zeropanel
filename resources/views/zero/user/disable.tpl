...
<html lang="en">
    <head>
        <title>Disabled - {$config["appName"]}</title>
                                    ...
                                    <div class="col-12">
                                        <div class="card card-custom gutter-b ">
                                            ...
                                            <div class="pb-20 pt-10 text-center">
                                                <h3 class="display-4 text-center font-weight-bolder">您的账号已被暂停使用</h3>
                                                <h3 class="display-4 text-center font-weight-bolder">如有疑问请联系客服或者发送工单</h3>
                                            </div>
                                        </div>
