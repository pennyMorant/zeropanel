    ...
    private $softs        = [
        ...
        */
        [
            'name'      => 'SagerNet',
            'tagMethod' => 'github_release',
            'gitRepo'   => 'SagerNet/SagerNet',
            'savePath'  => 'public/clients/',
            'downloads' => [
                [
                    'sourceName' => 'SN-%tagName%-arm64-v8a.apk',
                    'saveName'   => 'sagernet.apk',
                    'apkpureUrl' => ''
                ]
            ],
        ],
        ...
        */
        ...
        [
            'name'      => 'Surfboard',
            'tagMethod' => 'github_release',
            'gitRepo'   => 'getsurfboard/surfboard',
            'savePath'  => 'public/clients/',
            'downloads' => [
                [
                    'sourceName' => 'mobile-arm64-v8a-release.apk',
