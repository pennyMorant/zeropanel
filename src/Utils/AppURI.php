...
class AppURI
{
    ...
    public static function getV2RayNURI(array $node_config)
    {
        $return = null;
    ...
    public static function getSurgeURI(array $node_config)
    {
        $return = null;
            switch ($node_config['type']) {
                case 'shadowsocks':
    ...
    public static function getQuantumultURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
    ...
    public static function getQuantumultXURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
    ...
    public static function getSurfboardURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
    ...
    public static function getClashURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
    ...
    public static function getShadowrocketURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
    ...
    public static function getKitsunebiURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
    ...
    public static function getTrojanURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'trojan':
    ...
    public static function getAnXrayURI(array $node_config)
    {
        $return = null;
        switch ($node_config['type']) {
            case 'shadowsocks':
